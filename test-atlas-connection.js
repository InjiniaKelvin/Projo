...
async function testConnection() {
 ...
 console.log('[COMPLETED] MongoDB Atlas connection successful!');
 console.log('');
 ...
 console.log('[DOCUMENTATION] Database:', dbName);
 console.log('[METRICS] Collections:', collections.length > 0 ? collections.map(c => c.name).join(', ') : 'None yet (will be created automatically)');
 console.log('');
 ...
 console.log('[COMPLETED] Write test successful!');
 
 // Cleanup
 await TestModel.deleteMany({ test: 'Connection test from QuickFix' });
 
 await mongoose.disconnect();
 console.log('[COMPLETED] Test complete! Your MongoDB Atlas is ready.\n');
 ...
 console.error('[TIMER] Timeout Issue:');
