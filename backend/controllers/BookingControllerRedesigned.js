/**
 * REDESIGNED BOOKING CONTROLLER - PHONE-BASED CLIENT ID
 * 
 ...
 */
 ...
 const bookings = await BookingRedesigned.find({ clientPhone: normalizedPhone })
 .sort({ submittedAt: -1 })
 .lean();
 ...
 */
 ...
 const booking = await BookingRedesigned.findOne({ bookingId })
