...
async function testBookingRetrieval() {
 ...
 console.log('OK SUCCESS - Retrieved by Booking ID');
 console.log(' Service:', response.data.data.serviceType);
 console.log(' Status:', response.data.data.status);
 console.log(' Client:', response.data.data.clientName);
 successCount++;
 } else {
 console.log('FAIL FAILED - API returned success: false');
 console.log(' Message:', response.data.message);
 failCount++;
 }
 } catch (error) {
 console.log('FAIL FAILED - Error retrieving by Booking ID');
 if (error.response) {
 ...
 if (response.data.success) {
 console.log('OK SUCCESS - Retrieved by Phone Number');
 ...
 console.log('FAIL FAILED - Error retrieving by Phone (+254)');
 if (error.response) {
 console.log(' Status:', error.response.status);
 console.log(' Message:', error.response.data.message || error.response.data);
 } else {
 ...
 if (response.data.success) {
 console.log('OK SUCCESS - Retrieved by Phone Number (alt format)');
 console.log(' Bookings found:', response.data.data.length);
 if (response.data.data.length > 0) {
 console.log(' Latest booking:', response.data.data[0].bookingId);
 }
 ...
 console.log('FAIL FAILED - Error retrieving by Phone (alt format)');
 if (error.response) {
 console.log(' Status:', error.response.status);
 console.log(' Message:', error.response.data.message || error.response.data);
 } else {
 ...
 if (response.data.success) {
 console.log('OK SUCCESS - Retrieved by Email');
 console.log(' Bookings found:', response.data.data.length);
 if (response.data.data.length > 0) {
 console.log(' Latest booking:', response.data.data[0].bookingId);
 console.log(' Service:', response.data.data[0].serviceType);
 ...
 console.log('FAIL FAILED - Error retrieving by Email');
 if (error.response) {
 console.log(' Status:', error.response.status);
 console.log(' Message:', error.response.data.message || error.response.data);
