...
echo "  → ${RED}⚠️  SAVE THIS PASSWORD! You'll need it next${NC}"
...
echo -e "${GREEN}📝 Now paste your connection string:${NC}"
...
if [[ $MONGO_URI == mongodb+srv://* ]] || [[ $MONGO_URI == mongodb://* ]]; then
    ...
    echo -e "${GREEN}✅ Connection string format looks good!${NC}"
    echo ""
