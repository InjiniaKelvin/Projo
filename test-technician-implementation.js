...
function logInfo(message) {
 log(`[INFO] INFO: ${message}`, 'gray');
}

function logWarning(message) {
 log(`[WARNING] WARN: ${message}`, 'yellow');
}
...
async function runAllTests() {
 ...
 logError('[FAILED] Backend is not running! Start with: npm run dev');
 ...
 log('╔═══════════════════════════════════════════════════════════╗', 'red');
 log('║ [WARNING] SOME TESTS FAILED [WARNING] ║', 'red');
