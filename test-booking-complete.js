...
async function runTest() {
  ...
  try {
    ...
    console.log(`  Critical Booking:  ${results.criticalBooking ? '✓ PASS' : '✗ FAIL'}`);
    console.log(`  Normal Booking:    ${results.normalBooking ? '✓ PASS' : '✗ FAIL'}`);
    ...
    console.log(`  Login:             ${results.login ? '✓ PASS' : '✗ FAIL'}`);
    console.log(`  Critical Booking:  ${results.criticalBooking ? '✓ PASS' : '✗ FAIL'}`);
    console.log(`  Normal Booking:    ${results.normalBooking ? '✓ FAIL' : '✗ FAIL'}`);
