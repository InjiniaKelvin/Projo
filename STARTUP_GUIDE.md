...
2. **Wait** for the server to start (you'll see "🚀 Server running on port 3000")
...
- ✅ **Frontend (Expo)**: Running on web
- ⏳ **Backend (Node.js)**: Ready to start
