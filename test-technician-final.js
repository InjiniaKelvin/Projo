...
async function runAllTests() {
  ...
  if (results.failed === 0) {
    log('🎉 ALL TESTS PASSED! Technician Dashboard is 100% functional!', 'success');
  } else {
    log(`⚠️  ${results.failed} test(s) failed. Check logs above.`, 'error');
  }
}
