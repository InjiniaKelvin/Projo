...
echo "🚀 Setting up Redesigned Booking System..."
echo "=========================================="
...
if [ -f "server.js" ]; then
    ...
    if ! grep -q "bookingRedesigned" server.js; then
        ...
        echo -e "${GREEN}✅ Added redesigned booking routes to server.js${NC}"
    else
        echo -e "${GREEN}✅ Redesigned booking routes already configured${NC}"
    fi
else
...
echo -e "${BLUE}📚 Creating startup guide...${NC}"
