...
console.log('[TIMER] Timeout: 30 seconds\n');
...
.then(() => {
 ...
 console.log(`[METRICS] Database: ${mongoose.connection.name}`);
...
.then(() => {
 console.log('[COMPLETED] Database ping successful!\n');
 console.log('[SUCCESS] MongoDB Atlas is working correctly!');
